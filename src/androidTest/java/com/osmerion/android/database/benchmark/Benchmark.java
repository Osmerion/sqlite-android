 ...
 */
package com.osmerion.android.database.benchmark;
...
public class Benchmark {
    ...
    private void testRequerySQLiteWrite(Statistics statistics) {
        ...
        com.osmerion.android.database.sqlite.SQLiteDatabase db = requerySQLite.getWritableDatabase();
        com.osmerion.android.database.sqlite.SQLiteStatement statement = db.compileStatement(
            String.format("insert into %s (%s, %s) values (?,?)",
                Record.TABLE_NAME,
                Record.COLUMN_CONTENT,
                Record.COLUMN_CREATED_TIME));
    ...
    private void testRequerySQLiteRead(Statistics statistics) {
        ...
        Cursor cursor = null;
        try {
            com.osmerion.android.database.sqlite.SQLiteDatabase db =
    ...
    private static class RequerySQLite extends
            com.osmerion.android.database.sqlite.SQLiteOpenHelper {
        public RequerySQLite(Context context, String name) {
            super(context, name, null, 1);
        }

        @Override
        public void onCreate(com.osmerion.android.database.sqlite.SQLiteDatabase db) {
            db.execSQL(Record.CREATE_STATEMENT);
        }

        @Override
        public void onUpgrade(com.osmerion.android.database.sqlite.SQLiteDatabase db,
