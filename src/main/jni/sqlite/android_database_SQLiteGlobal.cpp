...
static jint nativeReleaseMemory([[maybe_unused]] JNIEnv* env, [[maybe_unused]] jclass clazz) {
...
int register_android_database_SQLiteGlobal(JNIEnv *env)
{
    ...
    return jniRegisterNativeMethods(env, "com/osmerion/android/database/sqlite/SQLiteGlobal",
